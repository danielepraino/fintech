    ...
    <mat-form-field class="w-full" appearance="fill">
      ...
      <mat-form-field class="w-full" appearance="fill">
          ...
          <input
            ...
            required
          >
          <mat-hint align="end">{{passwordRegisterRef.value?.length}} / 20</mat-hint>
          <mat-icon matPrefix class="my-icon">lock</mat-icon>
          <mat-icon matSuffix (click)="showPasswordRegister = !showPasswordRegister">{{ showPasswordRegister ? "visibility" : "visibility_off" }}</mat-icon>
          <mat-error *ngIf="passwordRegisterRef.errors?.['minlength']">
                La password deve essere di minimo {{passwordRegisterRef.errors?.['minlength'].requiredLength}} caratteri
          </mat-error>
        ...
        <mat-form-field class="w-full" appearance="fill">
          ...
          <input
            ...
            required
          >
          <mat-hint align="end">{{passwordRegisterRepeat.value?.length}} / 20</mat-hint>
          <mat-icon matPrefix class="my-icon">lock</mat-icon>
          <mat-icon matSuffix (click)="showPasswordRegisterRepeat = !showPasswordRegisterRepeat">{{ showPasswordRegisterRepeat ? "visibility" : "visibility_off" }}</mat-icon>
          <mat-error *ngIf="passwordRegisterRepeat.errors?.['minlength']">
                La password deve essere di minimo {{passwordRegisterRepeat.errors?.['minlength'].requiredLength}} caratteri
          </mat-error>
          <mat-error *ngIf="passwordRegisterRepeat.errors?.['required']">
                La password è obbligatioria
          </mat-error>
        </mat-form-field>
      <button type="submit" class="w-full" mat-raised-button color="primary">Registrati</button>
