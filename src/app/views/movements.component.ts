...
@Component({
  ...
  template: `
    <div class="w-full">
      ...
      <button class="w-full" mat-stroked-button>Carica altro</button>
    </div>
  `,
  styles: [
  ]
...
export class MovementsComponent implements OnInit {
  ...
  movementsByCard(cardId: any) {
    ...
    return this.filteredMovements = this.filteredMovements.filter(movement => movement._id == cardId.value);
  }
}
